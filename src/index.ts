...
const main = {
    ...
    "პროცესების აღწერილობები":
      "არსებობს პროცესების დოკუმენტების მართვის ინსტიტუციონალიზებული, მდგრადი პრაქტიკა - ფორმალური წესებითა და მეთოდებით, რომელიც უზრუნველყოფს აღწერილობების დროულ განახლებას, ვერსიების კონტროლს, შენახვას, შესაბამისი დაინტერესებული მხარისთვის სწრაფ გაზიარებას.",
    ...
    "მმართველობის როლი":
      "კროს-ფუნქციურ პროცესს (პროცესი რომელშიც მონაწილეობს ორი, ან მეტი სტრუქტურული ერთეული) ჰყავს მმართველი, რომელიც პასუხისმგებელია ამ პროცესის შედეგებზე.",
    "გადაწყვეტილებების მიღების პრაქტიკები":
      "გადაწყვეტილებები მიიღება არსებული ინფორმაციის, მონაცემების სიღრმისეული მოდელირების და ანალიზის საფუძველზე. შუა რგოლის მენეჯმენტზე მკაფიოდაა დელეგირებული ბიზნეს-პროცესების განსახორციელებლად აუცილებელი სტანდარტული გადაწყვეტილებები.",
    "პროცესების გაუმჯობესების პრაქტიკები":
      "არსებული IT სისტემებიდან რეალურ დროში მიღებული ინფორმაცია მომხმარებლის გამოცდილების და პროცესის შესრულების შესახებ აქტიურად გამოიყენება პროცესების გაუმჯობესებისთვის. პროცესების გაუმჯობესების ციკლი უწყვეტი, სწრაფი და დინამიურია.",
    "ინფორმაციული ტექნოლოგიები":
      "კომპანიის საქმიანობაში ნაკლებად გამოიყენება ინფორმაციული ტექნოლოგიები.",
    "პროცესებზე დაფუძნებული ორგანიზაციული კულტურა":
      'ბიზნეს პროცესების გაუმჯობესება კომპანიის თანამშრომლების "ცხოვრების წესია". თანამშრომლები აქტიურად არიან დაკავებულები პროცესების გაუმჯობესების იდეების გენერირებით, კარგი სამუშაო პრაქტიკების იდენტიფიცირებითა და გაზიარებით.',
