...
const data = {
  ...
  "მოწოდებული ინფორმაცია დამუშავდება „პერსონალურ მონაცემთა დაცვის შესახებ“ საქართველოს კანონის შესაბამისად, წინამდებარე კითხვარიდან მიღებული ინფორმაციის ინტერპრეტაციისა და შედეგების ანგარიშის რესპონდენტისთვის გაგზავნის მიზნით. პერსონალური მონაცემები გამოყენებული იქნება მხოლოდ აღნიშნული მიზნებისთვის და თქვენი თანხმობის გარეშე არ გადაეცემა მესამე პირს. შევსებული კითხვარის გამოგზავნა ნიშნავს, რომ თანხმობა განაცხადეთ, თქვენს მიერ მოწოდებული ინფორმაციის დამუშავებაზე.":
    "ვეთანხმები",
  "პროცესის აღწერილობები":
    "პროცესები ფრაგმენტულადაა დოკუმენტირებული და უმეტესწილად ასახავენ სტრუქტურული ერთეულების შიდა საქმიანობას.",
  "პროცესის საზღვრები":
    "თანამშრომლების ან განყოფილებების საქმიანობის საზღვრები გარკვეულია, მაგრამ მათი ურთიერთქმედების წერტილები მკაფიოდ არ არის განსაზღვრული ან სტანდარტიზებული.",
  "თამანშრომლების ფუნქციები და როლები":
    "თანამშრომელთა როლები და ფუნქციები მკაფიოდაა განსაზღვრული და ერთგვაროვნად აღიქმება კომპანიის მასშტაბით.",
  "მომხმარებელზე ორიენტირებული ბიზნეს პროცესები":
    "კომპანიაში არ არის მკაფიო და შეთანხმებული წარმოდგენა, ვინ არიან “ჩვენი საბოლოო მომხმარებლები”. მომხმარებელთა საჭიროებები გათვალისწინებულია არასისტემატურად.",
  "პროცესების ინდიკატორები":
    "კომპანიაში შესრულების ინდიკატორების მონიტორინგი მიმდინარეობს რეალურ დროში, ანალიტიკის მოწინავე ტექნოლოგიების, როგორიცაა Business Activity Monitoring (BAM) სისტემები, ხელოვნური ინტელექტი (AI), და მანქანური სწავლების (ML) ალგორითმები. ინდიკატორები იძლევა შესაძლებლობას წინასწარ იდენტიფიცირდეს და აღმოიფხვრას პრობლემები.",
  "მმართველობის როლი":
    "ორგანიზაციაში დანერგილია ბიზნეს პროცესების მართვის ერთგვაროვანი პრაქტიკა. პროცესის მმართველის როლი მკაფიოა და მოიცავს პროცესების ანალიზს, ოპტიმიზაციას, დაგეგმვას, რესურსების უზრუნველყოფას და შესრულების მონიტორინგს.",
  "გადაწყვეტილებების მიღების პრაქტიკები":
    "კომპანიაში გადაწყვეტილებები ძირითადად ინტუიტურად და სპონტანურად მიიღება, უმეტესწილად კომპანიის დირექტორის მიერ.",
  "პროცესების გაუმჯობესების პრაქტიკები":
    "პროცესების გაუმჯობესება ხდება კროს-ფუნქციური გუნდების მეშვეობით. გამოიყენება სხვადასხვა მეთოდოლოგიები (Six Sigma, Lean, Agile და სხვა), თუმცა ორგანიზაციაში ერთიანი და სისტემატიზებული პრაქტიკა არ არის დანერგილი.",
  "ინფორმაციული ტექნოლოგიები":
    "კომპანიის IT სისტემები ინტეგრირებულია და არის პროცესების იდენტიფიცირებისა და გაუმჯობესების მნიშვნელოვანი წყარო.",
  "პროცესებზე დაფუძნებული ორგანიზაციული კულტურა":
    "კომპანიის თანამშრომლებს აქვთ ერთგვაროვანი წარმოდგენა ბიზნეს-პროცესების შესახებ და ასრულებენ დაწესებულ სტანდარტებს.",
};
interface JsonData {
